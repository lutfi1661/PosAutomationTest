...
public class NavPageSteps {
	...
	@And("user on table product page {string}")
	...
	@When("user clicks on table product page {string} button")
	public void user_clicks_on_table_product_page_page_button(String page) {
		driver.findElement(By.xpath("//a[text()='"+ page +"']")).click();;
	}

	@Then("user navigated to table product page {string}")
	public void user_navigated_to_table_product_page_page(String pageNow) {
